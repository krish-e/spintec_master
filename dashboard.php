...
<body>
     <script type="text/javascript">
         function hidenseek()
         {
            var session1 = $_SESSION["name"];
            if(session1 !="st01")        
            {                                                                    
                document.getElementById('counter').style.display = 'none';
            }
         }
         window.onload = hidenseek();
    </script>
            ...
            <ul class="nav">
                ...
                <li>
                    <?php
                        ...
                        //import "loginverification.php";
                        if(isset($_SESSION["name"]))
                            //echo $_SESSION["name"];
                        switch($_SESSION["name"])
                        {
                            case "st01" :   echo'<a href="inspection.html">';
                        }
                            ...
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
										...
										$query="select * from enquiry where status not like 'OK' ";
